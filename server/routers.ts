...
const courseInputSchema = z.object({
  ...
  scoreFormula: z.object({
    ...
    weightedBestOf: z.array(z.object({ subjects: z.array(z.string()), multiplier: z.number() })).optional(),
    requiredBestOf: z.array(z.array(z.string())).optional(),
    ...
    js4501Special: z.boolean().optional(),
    excludeLv2: z.boolean().optional(),
    bonusSubject: z.object({ multiplier: z.number(), subject: z.string().optional() }).optional(),
  }).optional(),
