...
const content = {
  "zh-TW": {
    ...
    sections: [
      {
        heading: "收集之資料",
        body: `當您使用本平台時，我們可能收集以下資料：（1）帳戶資料：您透過 Manus OAuth 登入時提供之姓名及電郵地址；（2）使用資料：您在本平台之操作記錄，包括搜尋記錄、收藏課程、志願選擇及 AI 查詢記錄；（3）技術資料：瀏覽器類型、IP 地址及訪問時間等技術資訊。`,
      },
      {
        heading: "資料用途",
        body: `我們收集之資料用於：（1）提供及改善本平台之服務；（2）儲存您的收藏課程及志願選擇；（3）提供個人化之 AI 課程推薦；（4）分析平台使用情況以改善用戶體驗；（5）防止欺詐及確保平台安全。`,
      },
      {
        heading: "資料儲存",
  ...
  "zh-CN": {
    ...
    sections: [
      {
        heading: "收集之资料",
        body: `当您使用本平台时，我们可能收集以下资料：（1）账户资料：您通过 Manus OAuth 登录时提供之姓名及电邮地址；（2）使用资料：您在本平台之操作记录，包括搜索记录、收藏课程、志愿选择及 AI 查询记录；（3）技术资料：浏览器类型、IP 地址及访问时间等技术信息。`,
      },
      {
        heading: "资料用途",
        body: `我们收集之资料用于：（1）提供及改善本平台之服务；（2）储存您的收藏课程及志愿选择；（3）提供个性化之 AI 课程推荐；（4）分析平台使用情况以改善用户体验；（5）防止欺诈及确保平台安全。`,
      },
      {
        heading: "资料储存",
